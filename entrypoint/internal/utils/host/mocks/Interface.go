...
func (_m *Interface) GetRedHatVersionInfo(ctx context.Context) (*host.RedhatVersionInfo, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetRedHatVersionInfo")
	}

	var r0 *host.RedhatVersionInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*host.RedhatVersionInfo, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *host.RedhatVersionInfo); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*host.RedhatVersionInfo)
		}
	}
...
// Interface_GetRedHatVersionInfo_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetRedHatVersionInfo'
type Interface_GetRedHatVersionInfo_Call struct {
	*mock.Call
}

// GetRedHatVersionInfo is a helper method to define mock.On call
//   - ctx context.Context
func (_e *Interface_Expecter) GetRedHatVersionInfo(ctx interface{}) *Interface_GetRedHatVersionInfo_Call {
	return &Interface_GetRedHatVersionInfo_Call{Call: _e.mock.On("GetRedHatVersionInfo", ctx)}
}

func (_c *Interface_GetRedHatVersionInfo_Call) Run(run func(ctx context.Context)) *Interface_GetRedHatVersionInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *Interface_GetRedHatVersionInfo_Call) Return(_a0 *host.RedhatVersionInfo, _a1 error) *Interface_GetRedHatVersionInfo_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Interface_GetRedHatVersionInfo_Call) RunAndReturn(run func(context.Context) (*host.RedhatVersionInfo, error)) *Interface_GetRedHatVersionInfo_Call {
	_c.Call.Return(run)
	return _c
}
